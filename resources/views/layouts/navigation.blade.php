        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="space-x-4">
                        <a href="{{ route('login') }}"
                            class="text-sm text-gray-500 hover:text-gray-700 dark:hover:text-gray-300">Войти</a>
                        <a href="{{ route('register') }}"
                            class="text-sm text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 font-bold">Регистрация</a>
                    </div>
                @endauth
            </div>
